...
def prediction(Gender, Married, ApplicantIncome, CoapplicantIncome, LoanAmount, Credit_History):   
    ...
    numerical_features = np.array([[ApplicantIncome, CoapplicantIncome, LoanAmount * 1000]])
    scaled_values = scaler.transform(numerical_features)  # Properly reshape and scale input
