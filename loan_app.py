...
def main():
    ...
    ApplicantIncome = st.slider("Applicant's Monthly Income", 0, 100000000, step=10000)
    CoapplicantIncome = st.slider("Coapplicant's Monthly Income", 0, 50000000, step=10000)
    LoanAmount = st.slider("Loan Amount", 0, 1000000000, step=10000)
