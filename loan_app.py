...
def prediction(Gender, Married, ApplicantIncome, CoapplicantIncome, LoanAmount, Credit_History):   
    ...
    # Combine all inputs into a single array for scaling
    input_features = np.array([[Gender, Married, ApplicantIncome, CoapplicantIncome, LoanAmount / 1000, Credit_History]])
    
    # Scale all input features
    scaled_features = scaler.transform(input_features)
    
    # Making predictions using the scaled features
