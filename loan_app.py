...
def main():
    ...
    ApplicantIncome = st.slider("Applicant's Monthly Income", 0, 1000000, step=10000)
    CoapplicantIncome = st.slider("Coapplicant's Monthly Income", 0, 500000, step=10000)
    LoanAmount = st.slider("Loan Amount", 0, 10000000, step=10000)
